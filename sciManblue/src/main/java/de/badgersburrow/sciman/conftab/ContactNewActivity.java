...
ll_topics = (LinearLayout)findViewById(R.id.ll_topics);
        	...
        	public void onClick(View v) {
        		...
        		{    
        			if (!allTopics.isItem(newTopic)){
        				...
        				VariousMethods.saveTopics(allTopics, ContactNewActivity.this);
        			} 
        			View topic_v;
        			LayoutInflater li = getLayoutInflater();
        			topic_v = li.inflate(R.layout.topic, null);
        ...
        bt_ok.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (thumbnailPath != null){
					...
					Time now = new Time();
					now.setToNow();
					String imagePath = VariousMethods.getMainFolder(ContactNewActivity.this)+Conf.getConfFolder()+"/" + lastname + "_" + now.format2445() + ".jpg";
					...
					try{
						...
						Toast.makeText(ContactNewActivity.this, "copying the picture to the Conference folder failed", Toast.LENGTH_LONG).show();
					}
      ...
      switch(requestCode) {
        case CAMERA_PIC_REQUEST: {//Activity.RESULT_OK: {
        	if (resultCode==Activity.RESULT_OK){
        		...
        		Toast.makeText(ContactNewActivity.this, "Picture not taken", Toast.LENGTH_LONG).show();
        	}
        ...
        case SELECT_PICTURE: {
        	if (resultCode==Activity.RESULT_OK){
        		...
        		Toast.makeText(ContactNewActivity.this, "No picture selected", Toast.LENGTH_LONG).show();
        	}
        	break;
        }
        default: {
    ...
    protected Dialog onCreateDialog(int id) {
     ...
     switch(id) {
        case dialog_topics:
         dialog = new Dialog(ContactNewActivity.this);
