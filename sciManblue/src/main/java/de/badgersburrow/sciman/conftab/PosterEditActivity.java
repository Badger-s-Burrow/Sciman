...
public class PosterEditActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {  
        ...
        if (theme_color.equalsIgnoreCase("White")){
        	setContentView(R.layout.poster_new_activity);
        	//TODO: bib_white);
        } else {
        	setContentView(R.layout.poster_new_activity);
        }
        ...
        Posteritem = (Poster)extras.getSerializable("poster");
        ...
        if (Posteritem instanceof Poster){
            ...
            String imageFile = Posteritem.getImagefile();
            if (imageFile!=null){
            	thumbnailPath = VariousMethods.getMainFolder(this) + Conf.getConfFolder() + imageFile;
            }
        ...
        bt_ok.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (newPicture){
					...
					Time now = new Time();
					now.setToNow();
					String imagePath = VariousMethods.getMainFolder(PosterEditActivity.this)+Conf.getConfFolder()+ "/" + lastname + "_" + now.format2445() + ".jpg";
					...
					Posteritem=new Poster(firstname,lastname,coauthor,title,abstracte,references,Posteritem.getImagefile(),Posteritem.getRotation(),0);
				}
        ...
        bt_camera.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {					
					thumbnailFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/tempposterpic.jpg");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
      ...
      switch(requestCode) {
        ...
        default: {
        	Toast.makeText(PosterEditActivity.this, "Picture not taken", Toast.LENGTH_LONG).show();
        	break;
        }
      }
    }
    ...
    public void onSaveInstanceState(Bundle savedInstanceState)
    {
      // EditTexts text
		...
		Posteritem=new Poster(firstname,lastname,coauthor,title,abstracte,references,null,rotation,0);
		savedInstanceState.putBoolean("newPicture", newPicture);
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState)
    {
      ...
      // EditTexts text
      newPicture= savedInstanceState.getBoolean("newPicture");
