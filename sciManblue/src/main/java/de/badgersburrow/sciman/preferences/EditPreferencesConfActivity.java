...
public class EditPreferencesConfActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener
{
    ...
    {	
        ...
        {*/
        	addPreferencesFromResource(R.xml.preferences_conf);
        /*}
        else{
